...
/**
 * Formata um número de telefone brasileiro (alias para formatPhone)
 * @param {string} value - Número de telefone a ser formatado
 * @returns {string} Telefone formatado
 */
...
/**
 * Formata um CNPJ (alias para formatDocument com CNPJ)
 * @param {string} value - CNPJ a ser formatado
