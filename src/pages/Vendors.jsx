              ...
              {filteredVendors.map((vendor) => (
                ...
                >
                  ...
                  <div className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                    {vendor.description && (
                      <p className="mb-1">{vendor.description}</p>
                    )}
                    {vendor.cnpj && (
                      <p>CNPJ: {vendor.cnpj}</p>
                    )}
                  </div>
                  
                  <div className="mt-2 flex items-center">
                    {renderSocialIcon('whatsapp', vendor.whatsapp)}
                    {renderSocialIcon('telegram', vendor.telegram)}
                    {renderSocialIcon('instagram', vendor.instagram)}
                    {renderSocialIcon('email', vendor.email)}
                    {renderSocialIcon('url', vendor.url)}
                  </div>
                </div>
              ))}
            </div>
