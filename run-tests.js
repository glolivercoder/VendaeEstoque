// Script para executar os testes do PDV Vendas no terminal
// Execute com: node run-tests.js

// Importar módulos necessários
import { register } from '@babel/register';
import { runSalesTests, runDateTests, runReportTests } from './src/utils/testRunner.js';

// Registrar Babel para transpilar código React
register({
