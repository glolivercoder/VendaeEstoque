/**
 * Script para criar um produto de teste no WooCommerce
 * Este script cria um produto de teste no WooCommerce para verificar se a integração está funcionando
 */
...
async function createTestProduct() {
  try {
    ...
    const product = {
      ...
      images: [
        {
          src: 'https://via.placeholder.com/800x600?text=PDV+Vendas+Teste'
        }
      ],
      meta_data: [
        {
